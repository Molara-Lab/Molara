...
class Ui_MOs_dialog(object):
    def setupUi(self, MOs_dialog):
        if not MOs_dialog.objectName():
            MOs_dialog.setObjectName("MOs_dialog")
        MOs_dialog.resize(400, 300)
        self.displayMos = QPushButton(MOs_dialog)
        self.displayMos.setObjectName("displayMos")
        ...
        self.orbitalSelector.setObjectName("orbitalSelector")
        ...
        self.cubeBoxSizeSpinBox.setObjectName("cubeBoxSizeSpinBox")
        ...
        self.toggleDisplayBoxButton.setObjectName("toggleDisplayBoxButton")
        ...
        self.checkBoxWireMesh.setObjectName("checkBoxWireMesh")
    ...
    def retranslateUi(self, MOs_dialog):
        MOs_dialog.setWindowTitle(
            QCoreApplication.translate("MOs_dialog", "Dialog", None)
        )
        self.displayMos.setText(
            QCoreApplication.translate("MOs_dialog", "Display Orbital", None)
        )
        self.label.setText(
            QCoreApplication.translate("MOs_dialog", "Orbital type:", None)
        )
        self.label_2.setText(
            QCoreApplication.translate("MOs_dialog", "Cartesian", None)
        )
        self.label_3.setText(
            QCoreApplication.translate("MOs_dialog", "Select Orbital", None)
        )
        self.label_4.setText(QCoreApplication.translate("MOs_dialog", "Box Size", None))
        self.toggleDisplayBoxButton.setText(
            QCoreApplication.translate("MOs_dialog", "Display Box", None)
        )
        self.label_5.setText(
            QCoreApplication.translate("MOs_dialog", "Voxel Size", None)
        )
        self.label_6.setText(QCoreApplication.translate("MOs_dialog", "Isovalue", None))
        self.checkBoxWireMesh.setText(
            QCoreApplication.translate("MOs_dialog", "Wire Mesh", None)
        )
