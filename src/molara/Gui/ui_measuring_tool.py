...
class Ui_measuring_tool(object):
    def setupUi(self, measuring_tool):
        ...
        measuring_tool.setMinimumSize(QSize(434, 271))
        measuring_tool.setMaximumSize(QSize(434, 271))
    ...
    def retranslateUi(self, measuring_tool):
        ...
        self.atom1_label.setText(
            QCoreApplication.translate(
                "measuring_tool",
                '<html><head/><body><p><span style=" font-weight:700; color:#ff0000;">1</span></p></body></html>',
                None,
            )
        )
        self.atom4_label.setText(
            QCoreApplication.translate(
                "measuring_tool",
                '<html><head/><body><p><span style=" font-weight:700; color:#ffff00;">4</span></p></body></html>',
                None,
            )
        )
        self.atom3_label.setText(
            QCoreApplication.translate(
                "measuring_tool",
                '<html><head/><body><p><span style=" font-weight:700; color:#0000ff;">3</span></p></body></html>',
                None,
            )
        )
        self.atom2_label.setText(
            QCoreApplication.translate(
                "measuring_tool",
                '<html><head/><body><p><span style=" font-weight:700; color:#00ff00;">2</span></p></body></html>',
                None,
            )
        )
