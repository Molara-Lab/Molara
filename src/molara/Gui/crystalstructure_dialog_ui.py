...
class Ui_CrystalDialog(object):
    ...
    def retranslateUi(self, CrystalDialog):
        ...
        self.selectSpaceGroup.setItemText(0, QCoreApplication.translate("CrystalDialog", u"m3m", None))
        self.selectSpaceGroup.setItemText(1, QCoreApplication.translate("CrystalDialog", u"4/mmm", None))
        self.selectSpaceGroup.setItemText(2, QCoreApplication.translate("CrystalDialog", u"mmm", None))
