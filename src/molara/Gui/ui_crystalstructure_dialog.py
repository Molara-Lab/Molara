...
class UiCrystalDialog:
    ...
    def retranslate_ui(self, crystal_dialog: CrystalDialog) -> None:
        ...
        self.selectSpaceGroup.setItemText(0, QCoreApplication.translate("crystal_dialog", "m3m", None))
        self.selectSpaceGroup.setItemText(1, QCoreApplication.translate("crystal_dialog", "4/mmm", None))
        self.selectSpaceGroup.setItemText(2, QCoreApplication.translate("crystal_dialog", "mmm", None))
