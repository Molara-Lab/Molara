...
class TestDrawer(TestCase):
    ...
    def test_setup(self) -> None:
        ...
        assert self.drawer_glucose.sphere_model_matrices.shape == (
            self.num_atoms_glucose,
            4,
            4,
        )
        assert self.drawer_glucose.sphere_translation_matrices.shape == (
            self.num_atoms_glucose,
            4,
            4,
        )
        assert self.drawer_glucose.sphere_scale_matrices.shape == (
            self.num_atoms_glucose,
            4,
            4,
        )
